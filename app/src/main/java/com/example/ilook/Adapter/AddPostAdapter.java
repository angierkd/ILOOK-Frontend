...
public class AddPostAdapter extends RecyclerView.Adapter<AddPostAdapter.ViewHolder>{
    ...
    public AddPostAdapter(ArrayList<Uri> list, Context context) {
        mData = list ;
        mContext = context;
    }
    ...
    public AddPostAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_post_add, parent, false) ;	// 리사이클러뷰에 들어갈 아이템뷰의 레이아웃을 inflate.
        AddPostAdapter.ViewHolder vh = new AddPostAdapter.ViewHolder(view) ;
